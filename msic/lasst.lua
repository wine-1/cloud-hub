...
local redzlib = {
  ...
  Darker = {
    ...
    Green = {
      ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 5, 61)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 5, 61)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 5, 61))
      }),
      ["Color Hub 2"] = Color3.fromRGB(0, 5, 61),
      ["Color Stroke"] = Color3.fromRGB(0, 5, 61),
      ["Color Theme"] = Color3.fromRGB(0, 5, 61),
      ["Color Text"] = Color3.fromRGB(243, 243, 243),
      ["Color Dark Text"] = Color3.fromRGB(180, 180, 180)
    },
    Troll = {
...
function redzlib:MakeWindow(Configs)
  ...
  function Window:MakeTab(paste, Configs)
    ...
    function Tab:AddColorpicker(Configs)
      ...
      local CustomColorFrame = Create("Frame", ScreenGui, {
        Size = UDim2.new(0, targetWidth, 0, targetHeight),
        Position = UDim2.new(0.5, 0, 0.5, 0),
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(0, 5, 61),
        BackgroundTransparency = 0.1,
      ...
      local TopBar = Create("Frame", CustomColorFrame, {
        ...
        BackgroundColor3 = Color3.fromRGB(0, 10, 80),
        BackgroundTransparency = 0.2
      })
      ...
      local ColorCodeBox = Create("TextBox", CustomColorFrame, {
        ...
        BackgroundColor3 = Color3.fromRGB(0, 8, 70),
